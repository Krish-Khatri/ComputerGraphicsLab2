...
int main() {
	...
	Button* addhex = new Button(25, 570, 100, 20, "Hexagon");
	addhex->callback(GeometryViewer::addShapeCb, &shapeData3);

	pair<GeometryViewer*, TGShape> shapeData4 = make_pair(&ov, TG_OCT);
	Button* addoct = new Button(130, 570, 100, 20, "Octagon");
	addoct->callback(GeometryViewer::addShapeCb, &shapeData4);

	pair<GeometryViewer*, TGShape> shapeData5 = make_pair(&ov, TG_CIRC);
	Button* addcirc = new Button(25, 605, 100, 20, "Circle");
	addcirc->callback(GeometryViewer::addShapeCb, &shapeData5);

	pair<GeometryViewer*, TGShape> shapeData6 = make_pair(&ov, TG_PENT);
	Button* addpent = new Button(130, 605, 100, 20, "Pentagon");
	addpent->callback(GeometryViewer::addShapeCb, &shapeData6);
